...
class Model:
    def __init__(self):
        ...
        self.__fixed_low_sigma = Variable(2.0) # in microns
        self.__moving_low_sigma = Variable(2.0)
        self.__fixed_min_distance = Variable(10.0)
        self.__moving_min_distance = Variable(10.0)
    ...
    @property
    def max_neighbors(self) -> typing.List[Variable]:
